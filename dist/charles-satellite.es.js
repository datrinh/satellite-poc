...
var _style_0 = "*[data-v-418e00ec]{font-size:16px;color:green}main[data-v-418e00ec]{--tw-bg-opacity: 1;background-color:rgba(255,255,255,var(--tw-bg-opacity));padding:1rem;position:fixed;right:.5rem;bottom:5rem;--tw-shadow-color: 0, 0, 0;--tw-shadow: 0 1px 3px 0 rgba(var(--tw-shadow-color), .1), 0 1px 2px 0 rgba(var(--tw-shadow-color), .06);-webkit-box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow)}.cta-btn[data-v-418e00ec]{--tw-bg-opacity: 1;background-color:rgba(252,211,77,var(--tw-bg-opacity));border-radius:9999px;border-style:none;cursor:pointer;height:4rem;position:fixed;bottom:.5rem;right:.5rem;--tw-shadow-color: 0, 0, 0;--tw-shadow: 0 1px 3px 0 rgba(var(--tw-shadow-color), .1), 0 1px 2px 0 rgba(var(--tw-shadow-color), .06);-webkit-box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow);box-shadow:var(--tw-ring-offset-shadow, 0 0 #0000),var(--tw-ring-shadow, 0 0 #0000),var(--tw-shadow);width:4rem}.slide-fade-enter-active[data-v-418e00ec],.slide-fade-leave-active[data-v-418e00ec]{transition:all .3s ease-in-out}.slide-fade-enter-from[data-v-418e00ec],.slide-fade-leave-to[data-v-418e00ec]{transform:translateY(10px);opacity:0}\n";
const _withScopeId = (n) => (pushScopeId("data-v-418e00ec"), n = n(), popScopeId(), n);
const _hoisted_1 = { key: 0 };
const _hoisted_2 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("img", {
  alt: "Vue logo",
  src: _imports_0
}, null, -1));
const _hoisted_3 = /* @__PURE__ */ _withScopeId(() => /* @__PURE__ */ createBaseVNode("p", { class: "text-pink-500" }, " TEST PARAGRAPH ", -1));
...
var AppCustomElement = /* @__PURE__ */ _export_sfc(_sfc_main, [["styles", [_style_0]], ["__scopeId", "data-v-418e00ec"]]);
